...
PERTURBATION_INTENSITY = {
    "low": {
        ...
        "sentence": {
            "sentence_repetition": 3,            # 重复次数 (进一步提升)
    ...
    "medium": {
        ...
        "sentence": {
            "sentence_repetition": 5,            # 使用高强度参数
            "sentence_order_shuffle": True,      # 局部/全局打乱
            "sentence_insertion": 0.50,          # 使用高强度参数
    ...
    "high": {
        ...
        "sentence": {
            "sentence_repetition": 7,            # 进一步增强
            "sentence_order_shuffle": True,      # 局部/全局打乱
            "sentence_insertion": 0.80,          # 进一步增强，用于计算插入数量
